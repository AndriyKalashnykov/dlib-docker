...
# dlib-docker
[DLib](https://github.com/davisking/dlib) Docker image for linux/amd64,linux/arm64,linux/arm/v7 with custom c++ and [DLib](https://github.com/davisking/dlib) build from sources
